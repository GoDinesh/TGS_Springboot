...
public class FeesTypeController {
	...
	private ResponseEntity<ResponseModel> getAllFeesType(){
		ResponseModel res = new ResponseModel(Constants.GET_RECORD,Constants.SUCCESS, false ,feesTypeService.getAllFeesType());
		return new ResponseEntity<>(res, HttpStatus.OK);
	}
	
	@PostMapping("/insert")
	private ResponseEntity<ResponseModel> saveFeesType(@Valid @RequestBody FeesType feesType) {
		ResponseModel res = new ResponseModel(Constants.CREATE_RECORD,Constants.SUCCESS, true ,feesTypeService.saveFeesType(feesType));
